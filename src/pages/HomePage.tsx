...
export default function HomePage() {
    ...
    return (
        <div style={{ textAlign: "start", padding: "40px 60px" }}>
            <div style={{ textAlign: "start" }}>
                ...
                <div style={{ width: screens.md ? "60vw" : "100vw", fontFamily: "Raleway" }}>
                ...
                <Row gutter={[32, 32]} justify="center" typeof="flex">
                    <Col xs={12}>
                        ...
                        >
                            <Card.Meta title={<div style={{ fontWeight: 500, fontSize: "16px", textAlign: "center" }}>{"Explainable Predictive Process Analytics"}</div>} />
                        </Card>
                    </Col>
                    <Col xs={12}>
                        <Card style={{ height: "100%", borderRadius: "20px" }} hoverable
                        ...
                        >
                            <Card.Meta title={<div style={{ fontWeight: 500, fontSize: "16px", textAlign: "center" }}>{"Probabilistic & Causal Models for Responsible AI"}</div>} />
                        </Card>
                    </Col>
                    <Col xs={12}>
                        <Card style={{ height: "100%", borderRadius: "20px" }} hoverable
                        ...
                        >
                            <Card.Meta title={<div style={{ fontWeight: 500, fontSize: "16px", textAlign: "center" }}>{"Persuasive Models for Explainable AI"}</div>} />
                        </Card>
                    </Col>
                    <Col xs={12}>
                        <Card style={{ height: "100%", borderRadius: "20px" }} hoverable
                        ...
                        >
                            <Card.Meta title={<div style={{ fontWeight: 500, fontSize: "16px", textAlign: "center" }}>{"Explainable Medical Diagnostic Systems"}</div>} />
                        </Card>
                    </Col>
                </Row>
            </div>
